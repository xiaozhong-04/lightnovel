<template>
  <div class="stackroom">
    <Loading
      v-if="bannerShow"
      style="position: absolute;height: 540px;"
    ></Loading>
      ...
      <div class="roomcentre" id="wrap">
        ...
        <div class="slide_text">
          <p class="slide_text_p1">
            ...
            <i class="continue continue-blue" v-if="bannerData.novel_status"
              >已完结</i
            >
          ...
          <p class="slide_text_p3">
            ...
            <span class="weekValue">
              <template v-if="bannerData.hot_vals">
                <i
                  class="week-number"
                  v-for="(item, i) in bannerData.hot_vals"
                  :key="i"
                  >{{ item }}</i
                >
              </template>
          ...
          <ul class="classify_option">
            <li>
              <a
                href="javascript:;"
                :class="classNames[0]"
                @click="getnovelTypeList"
                >全部</a
              >
            </li>
            <li>
              <a href="javascript:;" :class="classNames[1]" @click="getManList"
                >男频</a
              >
            </li>
            <li>
        ...
        <div class="classify">
          ...
          <ul class="classify_option">
            ...
            <li>
              <a
                href="javascript:;"
                :class="classifyArr[11]"
                @click="getXianyanList"
                >现言</a
              >
            </li>
            <li>
            ...
            <li>
              <a
                href="javascript:;"
                :class="classifyArr[13]"
                @click="getHuanyanList"
                >幻言</a
              >
            </li>
          </ul>
              ...
              >
                <a :href="/book/ + novelTxtItem.id" class="clearfix">
                  ...
                  <div class="exhibit_clearfix">
                    ...
                    <p class="store_tag">
                      <span class="bkcate_icon">{{
                        novelTxtItem.novel_classify
                      }}</span>
                      <a :href="/author/ + novelTxtItem.id">
                        <span class="bkuser_icon">{{
                          novelTxtItem.novel_author
                        }}</span>
                      </a>
                    </p>
                  </div>
        ...
        <el-tabs v-model="activeName">
          <el-tab-pane label="版权推荐" name="first">
            <ul class="datas clearfix">
              <li
                v-for="copyrightItem in copyrightList"
