    ...
    <el-container>
            ...
            <ul>
              ...
              <li>
                <a
                  ...
                  >登录</a
                >
                <a href="javascript:;" v-else>我的</a>
              </li>
              <li>
                <span>|</span>
              </li>
              <li>
                <a v-if="!isNo" @click="centeDialogVisible = true">注册</a>
                <a v-else @click="outLogin">退出</a>
              </li>
            </ul>
          </div>
      ...
      <el-footer style="height:180px;overflow:hidden">
        <div class="common bottom">
          ...
          <p>
            <span class="left">轻阅读小说 书旗网</span>
            <span class="right"
              >粤ICP备13078413号-6 增值电信业务许可证 粤B2-20130742
              网络文化经营许可证 粤网文[2017]3018-499号</span
            >
          </p>
          <p>
            <span class="left"
              >请使用者仔细阅读轻阅读小说《轻阅读小说用户服务协议》、《隐私保护政策》说明</span
            >-->
          </p>
          <p>
            <span class="left"
